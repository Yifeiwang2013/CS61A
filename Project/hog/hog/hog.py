...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls>0:
        Single_Result = dice()
        #print(Single_Result)
        if Single_Result == 1: Total_Result = 1
...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    return FIRST_101_DIGITS_OF_PI//10**(100-score)%10 + 3
    # END PROBLEM 2
...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    Lower_Score = min(player_score,opponent_score)
    Divisor=Lower_Score
    while Divisor >= 10:
        if player_score%Divisor == opponent_score%Divisor == 0:return True
        Divisor = Divisor - 1
    return False
...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    return True if opponent_score - player_score < 3 and opponent_score - player_score > 0 else False
    # END PROBLEM 4b
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def NewHighestGain(score0, score1):
        if who == 0:
        ...
        if Gain > running_high:
            ...
            NewHigh = running_high

        return announce_highest(who,LastRun,NewHigh)

    return NewHighestGain
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    for i in reversed(range(10)): 
        if HighestAve <= make_averaged(roll_dice)(i+1,dice):
            HighestAve = make_averaged(roll_dice)(i+1,dice)
            Max_scoring_num = i+1
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    Roll_Zero_Score = free_bacon(opponent_score)

    if extra_turn(score+Roll_Zero_Score,opponent_score):
        return 0
